...
let inglestics = document.getElementById("inglestics");
crearBarra(inglestics);
...
function efectoHabilidades(){
    ...
    if(distancia_skills>=300 && entro==false){
        ...
        const intervalInglestics = setInterval(function(){
            pintarBarra(inglestics, 11, 5, intervalInglestics);
        },100);
    }
}
